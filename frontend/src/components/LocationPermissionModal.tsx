...
export default function LocationPermissionModal({ onLocationGranted, onClose }: LocationPermissionModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-white rounded-2xl p-6 shadow-2xl border-2 border-neutral-200 w-full max-w-md max-h-[80vh] overflow-y-auto relative">
          {/* Scrollable Content */}
          ...
          <div className="absolute bottom-0 left-0 w-full h-10 pointer-events-none bg-gradient-to-t from-white to-transparent" />
        </div>
      </motion.div>
    </motion.div>
  );
